dotnet_x86:
  '4.6.01055':
    ...
    uninstaller: 'C:\Windows\Microsoft.NET\Framework\v4.0.30319\SetupCache\v4.5.01055\Setup.exe'
  ...
  '4.6.00081':
    ...
    install_flags: '/q /norestart'
    uninstaller: 'C:\Windows\Microsoft.NET\Framework\v4.0.30319\SetupCache\v4.5.00081\Setup.exe'
    uninstall_flags: '/uninstall /x86 /q /norestart'
    msiexec: False
    locale: en_US
    reboot: False
