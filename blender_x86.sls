...
blender:
  ...
  2.74: 
    full_name:  'Blender'
    installer: 'http://ftp.nluug.nl/pub/graphics/blender/release/Blender2.74/blender-2.74-windows32.exe'
    install_flags: '/S'
  ...
  2.73a: 
    full_name:  'Blender'
    installer: 'http://ftp.nluug.nl/pub/graphics/blender/release/Blender2.73/blender-2.73a-windows32.exe'
    install_flags: '/S'
    uninstaller: '{{ PROGRAM_FILES }}\Blender Foundation\Blender\uninstall.exe'
    uninstall_flags: '/S'
    locale: en_US
