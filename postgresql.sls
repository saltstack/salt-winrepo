postgresql:
  '9.5':
    ...
    install_flags: ' --unattendedmodeui minimal --mode unattended --superpassword postgres --prefix %ProgramFiles%\PostgreSQL --datadir %ProgramFiles%\PostgreSQL\data'
    uninstaller: '%ProgramFiles%\PostgreSQL\uninstall-postgresql.exe'
