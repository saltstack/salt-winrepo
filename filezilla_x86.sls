filezilla_x86:
  '3.23.0.2':
    full_name: FileZilla Client 33.23.0.2
    installer: 'http://vorboss.dl.sourceforge.net/project/filezilla/FileZilla_Client/3.23.0.2/FileZilla_3.23.0.2_win32-setup.exe'
    install_flags: '/S'
  ...
  '3.22.2.2':
    ...
    installer: 'http://vorboss.dl.sourceforge.net/project/filezilla/FileZilla_Client/3.22.2.2/FileZilla_3.22.2.2_win32-setup.exe'
    install_flags: '/S'
    uninstaller: '%ProgramFiles%\FileZilla FTP Client\uninstall.exe'
    uninstall_flags: '/S'
    msiexec: False
  ...
  '3.13.1':
    ...
    installer: 'http://heanet.dl.sourceforge.net/project/filezilla/FileZilla_Client/3.13.1/FileZilla_3.13.1_win32-setup.exe'
    install_flags: '/S'
    uninstaller: '%ProgramFiles%\FileZilla FTP Client\uninstall.exe'
    uninstall_flags: '/S'
    msiexec: False
